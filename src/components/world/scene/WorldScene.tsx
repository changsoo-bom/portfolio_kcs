 ...
 *
 * 48% 이후로 알파를 길게 흘려 82% 에서 사라진다. 급하게 끊으면 경계에 테가 보인다.
 * 조명 위치를 살짝 위(46%)로 둔 건 위에서 비치는 느낌이 더 자연스럽기 때문이다.
 *
 * 손잡이는 둘 — 첫 rgba 의 알파가 빛의 세기, 마지막 정지점이 빛이 닿는 범위다.
 */
const GLOBE_LIGHT =
  "radial-gradient(circle at 50% 46%, rgba(150, 240, 220, 0.20) 0%, rgba(90, 190, 200, 0.10) 32%, rgba(60, 140, 170, 0.04) 48%, transparent 82%)";
